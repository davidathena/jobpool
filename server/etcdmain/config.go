...
import (
	...
	cconfig "yunli.com/jobpool/server/v2/config"
	"yunli.com/jobpool/server/v2/embed"
...
func (cfg *config) configFromCmdLine() error {
	...
	if cfg.ec.MinHeartbeatTTLCfg != "" {
		cfg.ec.MinHeartbeatTTL, err = time.ParseDuration(cfg.ec.MinHeartbeatTTLCfg)
		if err != nil {
			return err
		}
	}
