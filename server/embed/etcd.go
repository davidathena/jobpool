...
import (
	...
	"yunli.com/jobpool/client/v2/credentials"
	"yunli.com/jobpool/pkg/v2/debugutil"
	runtimeutil "yunli.com/jobpool/pkg/v2/runtime"
	"yunli.com/jobpool/server/v2/config"
	"yunli.com/jobpool/server/v2/etcdserver"
	"yunli.com/jobpool/server/v2/etcdserver/api/etcdhttp"
	"yunli.com/jobpool/server/v2/etcdserver/api/rafthttp"
	"yunli.com/jobpool/server/v2/etcdserver/api/v3rpc"
	"yunli.com/jobpool/server/v2/verify"
...
func StartEtcd(inCfg *Config) (e *Etcd, err error) {
	...
	srvcfg := config.ServerConfig{
		...
		JobParallelismLimit:                      cfg.JobParallelismLimit,
		...
		MinHeartbeatTTL:        cfg.MinHeartbeatTTL,
		MaxHeartbeatsPerSecond: 50.0,
		HeartbeatGrace:         10 * time.Second,
		FailoverHeartbeatTTL:   cfg.FailoverHeartbeatTTL,
